...
<table bgcolor="#99FF66" border="0" width="820" style="border-width: 0px" height="600" cellspacing="5">
	...
	<tr>
		...
		<td align="center" width="192">
				<a href="javascript:go('search.jsp')">
				<font size="5" color="#008000">Search Diseases</font></a><font size="5" color="#008000"></font></td>
		<td align="center" width="175">
				<a href="javascript:go('composemail.jsp')">
				<font size="5" color="#008000">Query Doctor</font></a></td>
		<td align="center" width="157">
				<a href="javascript:go('inbox.jsp')">
				<font color="#008000" size="5">View Reply</font></a></td>
		<td align="center">
		<b><a href ="logout.jsp"> 
